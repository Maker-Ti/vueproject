...
<script>
    export default {
        ...
        methods:{
            ...
            selectAll(){
                this.$http.get("http://localhost:8080/form/getWarningForm?startTime=0&endTime=0").then(
                    response => {
            ...
            selectByData(){
                ...
                this.$http.get("http://localhost:8080/form/getWarningForm?startTime="+startTime+"&endTime="+endTime).then(
                    response => {
                        if(response.body.code === 200){
                            this.allData = response.body.data;
