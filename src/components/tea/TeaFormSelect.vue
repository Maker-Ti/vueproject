    ...
    <div class="layout-content">
        <div class="layout-content-main">
           ...
           <div class="datepicker">
            ...
            <div class="datepicker mt10">

                <i-input v-model="stuInfo" placeholder="输入查询的学生姓名或学号（为空则不筛选）" style="width: 300px" class="" ></i-input>
                <i-button type="primary" @click="selectByData"  class="ml50" >
                    日期查询
                </i-button>
    ...
    export default {
        ...
        methods:{
            ...
            selectAll(){
                ...
                this.$http.get("http://localhost:8080/form/teaSelectForm?startTime=0&endTime=0&userInfo="+info).then(
                    response => {
            ...
            selectByData(){
                ...
                this.$http.get("http://localhost:8080/form/teaSelectForm?startTime="+startTime+"&endTime="+endTime+"&userInfo="+info).then(
                    response => {
                        if(response.body.code === 200){
                            this.allData = response.body.data;
