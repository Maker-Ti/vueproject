      ...
      <i-col :span="spanLeft" class="layout-menu-left" @click="toggleClick">
        ...
        <Menu active-key="1" theme="dark" width="auto" @on-select="itemClick" active-name="1">
          ...
          <Menu-item key="2"  name="2">
           <Icon type="ios-flame" :size="iconSize"></Icon>
              <span class="layout-text">体温报警</span>
...
<script>
  export default {
    created:function(){
      this.$router.push({name:'tea_select', params: { userName:this.$route.params.userName ,
    ...
    data () {
      return {
        ...
        click_btn_text:"隐藏",
        content_title:"报表查询",
        main_title:"体温申报系统管理-"+this.$route.params.userName,
    ...
    methods: {
      ...
      toggleClick () {
        ...
        if (this.spanLeft === 5) {
          ...
          this.main_title = "体温申报系统管理-"+this.$route.params.userName;
      ...
      itemClick: function(name){
        switch (name) {
          case '1':this.content_title="报表查询";
            this.$router.push({name:'tea_select', params: { userName:this.$route.params.userName ,
                userNumber:this.$route.params.userNumber,
                userId:this.$route.params.userId,
                userPwd:this.$route.params.userPwd}});
          ...
          case '2':this.content_title="体温报警";
            this.$router.push({name:'tea_warning', params: { userName:this.$route.params.userName ,
                userNumber:this.$route.params.userNumber,
                userId:this.$route.params.userId,
                userPwd:this.$route.params.userPwd}});break;

          case '3':this.content_title="更改密码";
            this.$router.push({name:'tea_changepwd', params: { userName:this.$route.params.userName ,
                userNumber:this.$route.params.userNumber,
                userId:this.$route.params.userId,
                userPwd:this.$route.params.userPwd}});break;
        }
